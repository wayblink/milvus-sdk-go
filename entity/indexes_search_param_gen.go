...
// This file is generated by go generate at 2023-05-25 12:16:04.596245 +0800 CST m=+0.010820043
...
var _ SearchParam = &IndexTRIESearchParam{}

// IndexTRIESearchParam search param struct for index type TRIE
type IndexTRIESearchParam struct { //auto generated fields
}

// Params returns index construction params, implementing Index interface
func(i *IndexTRIESearchParam) Params() map[string]interface{} {
	return map[string]interface{} {//auto generated mapping 
	}
}

// NewIndexTRIESearchParam create index search param
func NewIndexTRIESearchParam() (*IndexTRIESearchParam, error) {
	// auto generate parameters validation code, if any
	return &IndexTRIESearchParam{ 
	}, nil
}
